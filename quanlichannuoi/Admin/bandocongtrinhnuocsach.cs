...
{
    public partial class bandocongtrinhnuocsach : UserControl
    {
        public bandocongtrinhnuocsach()
        {
            InitializeComponent();
        }

        private void bandocongtrinhnuocsach_Load(object sender, EventArgs e)
        {
            LoadMap();
            LoadQuyHoachData();
        }
        private void LoadQuyHoachData()
        {
            ...
            string query = "SELECT TenCongTrinh, LoaiCongTrinh, TrangThai, Latitude, Longitude FROM CongTrinhNuocSach";
        ...
        private void txtSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = @"SELECT TenCongTrinh, LoaiCongTrinh, TrangThai, Latitude, Longitude 
                     FROM CongTrinhNuocSach 
                     WHERE TenCongTrinh = @Name";
